...
class IAttendanceRepository(ABC):
    ...
    @abstractmethod
    async def get_today_record(self, user_id: str, date: str) -> Optional[dict]: pass

    @abstractmethod
    async def get_history(self, user_id: str, year: int, month: int) -> List[dict]: pass
...
class AttendanceRepository(IAttendanceRepository):
    ...
    async def get_today_record(self, user_id: str, date: str) -> Optional[dict]:
        res = (
    ...
    async def get_history(self, user_id: str, year: int, month: int) -> List[dict]:
