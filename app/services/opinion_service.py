...
class OpinionService:
    ...
    async def create_opinion(self, user_id: str, body: OpinionCreate) -> Opinion:
        data = {
            "user_id": user_id,
    ...
    async def get_my_opinions(self, user_id: str) -> List[Opinion]:
        records = await self.opinion_repo.list_by_user(user_id)
